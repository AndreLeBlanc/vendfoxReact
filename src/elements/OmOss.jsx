                  ...
                  <div className="row mt--30">
                    <div className="col-lg-6 col-md-12 col-sm-12 col-12">
                      <div className="about-us-list">
                        ...
                        <p>
                          Vi analyserar ert företag, era behov och era nuvarande
                          IT-system. Tillsammans designar vi nya lösningar och
                          skriver en kravspecifikation. Vi erbjuder fasta priser
                          och avtalen är alltid med vårt svenska bolag.
                        </p>
                      </div>
                    </div>
                    <div className="col-lg-6 col-md-12 col-sm-12 col-12">
                      <div className="about-us-list">
                        ...
                        <p>
                          Dina lösningar utvecklas i sprintar på två veckor där
                          vi utvärderar och prioriterar arbetet efter varje
                          sprint. Projektledning, servrar och data hanteras
                          alltid från Sverige. Våra utvecklare i Sverige och
                          Indien utvecklar mjukvaran tillsammans.
                        </p>
                      </div>
                    </div>
                  </div>
