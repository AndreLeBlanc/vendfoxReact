          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="rn-page-title text-center pt--100">
                <h2 className="title theme-gradient">Design</h2>
                <p>
            ...
            <div className="col-lg-12">
              <div className="service-details-inner">
                    ...
                    <div className="col-lg-6 col-12">
                      <div className="details mt_md--30 mt_sm--30">
                        ...
                        <p>
                          ...
                          enkelt och intuitivt då det ger tydliga instruktioner
                          om var man ska klicka till visuell feedback. En bra UI
                          ska fungera såväl på datorn som i mobilen och fungera
                          för alla sorters användare oavsett deras
                          förutsättningar. Målet är att skapa en estetiskt
                          tilltalande samt funktionell och tydlig
                          användarupplevelse.{" "}
                        </p>
                        <p> </p>
                      </div>
                  ...
                  <div className="row service-details-content pb--40  align-items-center">
                    <div className="col-lg-6 col-12">
                      <div className="details mt_md--30 mt_sm--30">
                        ...
                        <p>
                          För att kunna designa era IT-system så behöver vi lära
                          känna er. Vi gör en förstudie där vi går igenom
                          eventuella existerande system, hur ni jobbar idag och
                          vilka mål ni har. Antingen så utgår vi från er
                          nuvarande grafiska profil eller så skapar vi en ny
                          tillsammans.{" "}
                        </p>
                        <p>
                          Vi kan jobba ihop på plats i Uppsala, Stockholm eller
                          Tranås eller så kan vi utan problem göra designarbetet
                          på distans. Arbetet genomförs i omgångar där du får
                          utvärdera designen efter var omgång. tillsammans ser
                          vi till att designen passar ert företag, hur ni jobbar
                          och är flexibel inför framtida ändringar. Oavsett om
                          det är en app eller hemsida så ska designen fungera på
                          mobilen. Det är en rolig fas av utvecklingen där många
                          idéer utvecklas och där man får se sin vision växa
                          fram.{" "}
                        </p>
                        <p>
                          När vi har gjort klart designen så presenterar vi en
                          fullt klickbar wireframe. Ni kan då klicka igenom er
                          nya hemsida, app eller webbutik och se hur den kommer
                          se ut och fungera när den väl är färdig.{" "}
                        </p>
                      </div>
                    </div>
                ...
                <div className="row service-details-content">
                  <div className="details">
                    ...
                    <ul className="liststyle">
                      ...
                      <li>
                        gör webbplattformar och appar lättare att bygga. En bra
                        design underlättar utvecklarnas arbete.
                      </li>
                ...
                <h4 className="title ContactText mt--120">
                  ...
                  idag för gratis konsultation om Design{" "}
                </h4>
