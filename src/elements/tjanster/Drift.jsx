          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="rn-page-title text-center pt--100">
                ...
                <p>Låt oss sköta era IT-system så du kan sköta ditt företag.</p>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div className="row service-details-content pb--40 align-items-center">
                    ...
                    <div className="col-lg-6 col-12">
                      <div className="details mt_md--30 mt_sm--30">
                        ...
                        <p>
                          Arbetet med era system slutar inte när de lanseras. Vi
                          ser till att tekniken fungerar och uppdateras. Det är
                          inte bara en fråga om att era system ska vara
                          anpassade till era behov även när världen ändras utan
                          är också en fråga om säkerhet. Med regelbunden översyn
                          så hålls system säkra och väl uppdaterade.{" "}
                        </p>
                        <p>
                  ...
                  <div className="row service-details-content pb--40  align-items-center">
                    <div className="col-lg-6 col-12">
                      <div className="details mt_md--30 mt_sm--30">
                        ...
                        <p>
                          Apple har jobbat på det som idag är macOS i över 40 år
                          och det kommer fortfarande regelbundna uppdateringar.
                          Många hemsidor som lanserades på 90-talet har
                          utvecklats och är idag moderna sidor anpassade till
                          företagets verksamhet så som den är nu. I&nbsp;många
                          fall är det bättre{" "}
                          <Link
                            to="/projektledning"
                ...
                <div className="row service-details-content">
                  <div className="details">
                    ...
                    <ul className="liststyle">
                      ...
                      <li>
                        ser till att era system har hög prestanda och optimeras
                        regelbundet. En snabb hemsida får fler användare och
                        rankas högre av google.
                      </li>
                      <li>
