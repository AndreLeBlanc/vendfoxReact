                  ...
                  <div className="row service-details-content pb--40 align-items-center">
                    ...
                    <div className="col-lg-6 col-12">
                      <div className="details mt_md--30 mt_sm--30">
                        <h2 className="title">Öka er försäljning på nätet </h2>
                        <p>
                          ...
                          på bollen och anpassa sig innan man blir omsprungen av
                          konkurrenterna.{" "}
                        </p>
                        <p>
                          ...
                          kan även rådge er när det gäller resten av e-handeln.
                          Efter att ha jobbat med många olika kunder i flera
                          olika länder så vet vi vad som fungerar och inte.
                          Därför kan vi erbjuda kompletta lösningar med CRM
                          system, affärssystem, logistik och strategier för att
                          lyckas med er e-handel.{" "}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="col-lg-6 col-12">
                      <div className="details mt_md--30 mt_sm--30">
                        ...
                        <p>
                          ...
                          driftskostnader till ett effektivt pris. Om ni vill ha
                          mer anpassad funktionalitet, egna produkter och full
                          kontroll över er hemsida kan våra{" "}
                          <Link
                            to="/webbutvecklare"
                            className="service-details-contactLink"
                          >
                ...
                <div className="row service-details-content">
                  <div className="details">
                    ...
                    <ul className="liststyle">
                      ...
                      <li>
                        Ni kan driva er webbutik utan att tvingas vara på plats
                        eller jobba vissa tider.{" "}
                      </li>
                      <li>
