...
export default function Projektledning() {
  return (
    <React.Fragment>
      {/* Start Pagehelmet  */}
                    ...
                    <div className="col-lg-6 col-12">
                      <div className="details mt_md--30 mt_sm--30">
                        ...
                        <p>
                          ...
                          någon utan erfarenhet. Det är många utvecklingsprojekt
                          som har misslyckats, gått över budget eller inte levt
                          upp till förväntningarna. Ofta beror detta på dålig
                          projektledning och dåliga upphandlingar snarare än att
                          projektet var ogörbart.{" "}
                        </p>
                        <p>
                          En hemsida eller app kan verka enkel att utveckla och
                          en komplex e-handelslösning kan verka svår men vara
                          enkel att lösa.{" "}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="row service-details-content pb--40  align-items-center">
                    <div className="col-lg-6 col-12">
                      <div className="details mt_md--30 mt_sm--30">
                        ...
                        <p>
                          Efter att ha jobbat många år inom konsultbranschen och
                          deltagit i många projekt så vet vi vad som fungerar.
                          Vi jobbar med{" "}
                          <Link
                          ...
                          stegvis. Istället för att bygga allt på ett bräde med
                          ett enda stort projekt så bryter vi ner projektet i
                          delprojekt (
                          <a
                          ...
                          tidigt, hitta sätt att förbättra produkten och se till
                          att det som byggs är den bästa lösningen för kunden.
                          Det är oftast slöseri att bygga en stor komplex
                          lösning från start. Istället är det bättre att bygga
                          en billigare och enklare lösning som snabbt kan komma
                          ut och testas med riktiga användare. Denna första
                          version ska samtidigt vara enkel att bygga vidare på
                          och utöka till den färdiga produkten.{" "}
                        </p>
                        <p>
                          Oavsett om ni vill att vi ska leda och utveckla er nya
                          nya IT-system eller om ni vill ha hjälp med en
                          upphandling kan vi bistå. Undvik att hamna i fällorna
                          och se till att er nya webbshop, hemsida eller app
                ...
                <div className="row service-details-content">
                  <div className="details">
                    ...
                    <ul className="liststyle">
                      ...
                      <li>
                        skapar bra långsiktiga relationer mellan beställaren och
                        kunden.
                      </li>
                    </ul>{" "}
                  </div>
