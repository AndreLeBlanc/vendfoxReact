                    ...
                    <div className="row service-details-content pb--40 align-items-center">
                      ...
                      <div className="col-lg-6 col-12">
                        <div className="details mt_md--30 mt_sm--30">
                          ...
                          <p>
                            Google är idag det främsta sättet för både företag
                            och privatpersoner att hitta företag. Varje dag
                            söker svenskarna 40 miljoner gånger på google och de
                            flesta som går in på en ny sida kommer från google.
                            För företag har det aldrig varit viktigare att synas
                            på google. Även kunder som har hört om ditt företag
                            offline kommer ofta söka på ditt företag innan de
                            gör en affär.
                          </p>
                          <p>
                            Ett sätt att synas på google är att köpa anonser.
                            Det kan ge kortsiktiga resultat men är dyrt utan att
                            ge något i längden. Att synas genom att ha en
                            sökmotoroptimerad hemsida eller webbshop är
                            billigare och ger resultat i längden.
                          </p>
                        </div>
                      </div>
                    </div>
