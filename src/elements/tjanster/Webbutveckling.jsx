          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="rn-page-title text-center pt--100">
                ...
                <p>
                  Skapa dynamiska och engagerande hemsidor, webbplattformar och
                  webbutiker.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-12">
              <div className="service-details-inner">
                    ...
                    <div className="col-lg-6 col-12">
                      <div className="details mt_md--30 mt_sm--30">
                        ...
                        <p>
                          ...
                          snygga och funktionella hemsidor med webbappar med de
                          funktioner som ert företag behöver.{" "}
                        </p>
                        <p>
                          Er hemsida ska lyfta ert företag och framhäva det som
                          gör att ni står ut. Istället för att använda
                    ...
                    <div className="col-lg-6 col-12">
                      <div className="details mt_md--30 mt_sm--30">
                        ...
                        <p>
                          ...
                          Större delen av arbetet av att utveckla en webbapp kan
                          återanvändas för att göra en{" "}
                          <Link
                            to="appar"
                            className="service-details-contactLink"
                          >
                          ...
                          appar för både Android och iOS har ni en plattform som
                          når alla era användare. Gränsen mellan webbutveckling
                          och mobilappsutveckling har blivit tunnare.{" "}
                        </p>
                        ...
                        <p>
                          ...
                          deras verksamhet tillsammans. Hemsidan eller webbappen
                          är en central del av kundernas företag och måste växa
                          och anpassas i takt med att behoven ändras. Med ett
                          supportavtal så ser vi till att eran plattform
                          fungerar, uppdateras och hålls säker. Webbutveckling
                          är mer än att bara bygga en hemsida.
                        </p>
                      </div>
                    </div>
                ...
                <div className="row service-details-content">
                  <div className="details">
                    ...
                    <ul className="liststyle">
                      <li>
                        låter er anpassa hemsidan till er verksamhet snarare än
                        att ni anpassar verksamheten till hemsidan.
                      </li>
                      <li>möjliggör en uppsjö av funktioner och idéer.</li>
                      <li>
                        skapar snabbare och snyggare hemsidor än hemsidor byggda
                        kring färdiga mallar.
                      </li>
                      <li>
                        går att bygga vidare på så de kan växa med ert företag.
                      </li>
                      <li>
                ...
                <h2 className="title ContactText mt--120">
                  ...
                  för en konsultation kring hur ni kan ska hemsidan ert företag
                  förtjänar.{" "}
                </h2>
