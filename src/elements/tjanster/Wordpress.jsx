                  ...
                  <div className="row service-details-content pb--40 align-items-center">
                    ...
                    <div className="col-lg-6 col-12">
                      <div className="details mt_md--30 mt_sm--30">
                        <h4 className="title">Webbutveckling med WordPress </h4>
                        <p>
                          <a
                          ...
                          är verktyget som skapat hälften av världens hemsidor.
                          Vi som grundat Vendfox har byggt hundratals hemsidor
                          med WordPress i över 12 år. Vi kan inte bara bygga och
                          designa er hemsida, vi har erfarenheten och kunskapen
                          att skapa er digitala strategi och sökmotoroptimering
                          för att se till att er hemsida verkligen levererar.{" "}
                        </p>
                        <p>
                          En wordpress sida kan vara så mycket mer än en statisk
                          hemsida. Med plugins så kan en uppsjö av olika
                          funktioner adderas till er hemsida. Många plugins
                          finns färdiga men vi utvecklar även egna. Det gör att
                          vi kan göra mer med Wordpress än de flesta.{" "}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row service-details-content pb--40  align-items-center">
                    <div className="col-lg-6 col-12">
                      <div className="details mt_md--30 mt_sm--30">
                        ...
                        <p>
                          Wordpress används av många E-handlare. Med plugins som{" "}
                          <a
                            className="service-details-contactLink"
                          ...
                          integreras med tjänster så som klarna, postnord eller
                          affärssystem. Läs mer om våra tjänster inom
                          <Link
                            className="service-details-contactLink"
                            to="/e-handel"
                          >
                        ...
                        <p>
                          {" "}
                          Vi driftar och underhåller er wordpress-sida. Till en
                          fast kostnad ser vi till att er hemsida fungerar. Ni
                          är experter på er verksamhet och ska inte behöva tänka
                          på er hemsidas drift. Med våra driftslösningar kommer
                          er hemsida hållas uppdaterad och säker till ett fast
                          pris.
                        </p>
                      </div>
                    </div>
